    ...
    <nav class="menu-opcoes">
		...
		<div class="container paineis">
            <section class="painel imagens">
                ...
                <center><img src="img/produtos/anel_esmeralda.jpg" height="265" width="225" alt="anel ouro 18k"></center>
				</form>
            </section>   
            <section class="painel legendas">
                <form action="checkout.php" method="POST">
                    <h1>Anel Esmeralda 18K</h1>
			        <p>por apenas R$ 3240,90</p>
                    <input type="hidden" name="nome" value="Anel Esmeralda 18K">
				    <input type="hidden" name="preco" value="3240,90">
