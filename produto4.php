    ...
    <nav class="menu-opcoes">
		...
		<div class="container paineis">
            <section class="painel imagens">
                ...
                <center><img src="img/produtos/anel_cartier.jpg" height="265" width="225" alt="anel ouro 18k"></center>
				</form>
            </section>   
            <section class="painel legendas">
                <form action="checkout.php" method="POST">
                    <h1>Anel Cartier 18K</h1>
			        <p>por apenas R$ 2529,90</p>
                    <input type="hidden" name="nome" value="Anel Cartier 18K">
				    <input type="hidden" name="preco" value="2529,90">
		    ...
		    <section class="detalhes">
			    ...
			    <center><h2>Detalhes do produto</h2></center>
